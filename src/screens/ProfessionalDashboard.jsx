...
import {
  ...
  PlayCircle, ChevronDown, HeartHandshake,
} from 'lucide-react';
import {
...
export default function ProfessionalDashboard({ profile, onSignOut }) {
  ...
  const stats = useMemo(() => {
    ...
    return { total: orders.length, ongoing, earnings };
  }, [orders]);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              <div className="glass-card-static p-5 rounded-2xl flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Pedidos recebidos</p>
                </div>
              </div>
              <div className="glass-card-static p-5 rounded-2xl flex items-center gap-4">
              ...
              <div className="glass-card-static p-5 rounded-2xl flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Ganhos liberados</p>
                </div>
              </div>
            </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {professional.isVerified && (
                      <span className="badge badge-verified"><ShieldCheck size={11} /> Verificado</span>
                    )}
                  </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {o.status === 'Em andamento' && (
                          <span className="text-[11px] text-amber-400 flex items-center gap-1.5">
                            <Zap size={13} /> Aguardando confirmação do cliente
                          </span>
                        )}
                        {o.status === 'Concluído' && (
                          <span className="text-[11px] text-emerald-400 flex items-center gap-1.5">
                            <CheckCircle2 size={13} /> Concluído e pago
                          </span>
                        )}
                      </div>
                    </div>
